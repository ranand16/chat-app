    ...
    >
      ...
      >
        <div className="flex items-start">
          <div className="flex-shirink-0 pt-0.5">
      ...
      <div className="flex border-l border-gray-400">
        <button
          ...
          className="w-full border-transparent rounded-none rounded-r-lg p-4 flex items-center justify-center text-sm font-medium text-ndigo-600 hover:text-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-500"
        >
          Close
        </button>
      </div>
